...
pkgbase=linux-navi
chromeos_release_version=143
chromeos_kernel_tag=16463
chromeos_kernel_branch=chromeos-6.6
_srcname=release-R${chromeos_release_version}-${chromeos_kernel_tag}.B-${chromeos_kernel_branch}
_kernelname=${pkgbase#linux}
_desc="AArch64 Navi Chromebook"
pkgver=6.6.99
pkgrel=1
arch=('aarch64')
...
options=('!strip')
source=("https://chromium.googlesource.com/chromiumos/third_party/kernel/+archive/refs/heads/${_srcname}.tar.gz"
        ...
        'linux.preset')
md5sums=('34a7da16c4669b3e7cc89dfee06ddd9d'
         '416b7c6ef37cc0edb6cb67cf618360f5'
         '533c78cb1e9e01ba501d97ae43c3110d'
